...
import com.networkinto.facility.common.config.properties.HttpClientProperties;
...
public class HttpClientConfig {
    ...
    public PoolingHttpClientConnectionManager poolingConnectionManager() {
        ...
        //同路由并发数
        poolingConnectionManager.setDefaultMaxPerRoute(httpClientProperties.getDefaultMaxPerRoute());
